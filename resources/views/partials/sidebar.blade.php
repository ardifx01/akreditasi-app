            ...
            <li class="nav-item mb-2">
                ...
                <div class="collapse" id="sdmCollapse">
                    <ul class="nav flex-column ms-3 mt-2">
                        ...
                        <li class="nav-item mb-1">
                            <a class="nav-link rounded py-2 px-3" href="{{ route('mou.index') }}"
                                style="color: #ddd; font-size: 0.9rem; transition: all 0.3s;">
                                <i class="fas fa-certificate me-2"></i>Data MoU
                            </a>
                        </li>
                    </ul>
                </div>
                        ...
                        <li class="nav-item mb-1">
                            ...
                            <div class="collapse" id="statistikKoleksiCollapse">
                                <ul class="nav flex-column ms-3 mt-1">
                                    <li class="nav-item">
                                        <a class="nav-link rounded py-1 px-3" href="{{ route('koleksi.prodi') }}"
                        ...
                        <li class="nav-item mb-1">
                            ...
                            <div class="collapse" id="jenisKoleksiCollapse">
                                <ul class="nav flex-column ms-3 mt-1">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link rounded py-1 px-3" href="{{ route('koleksi.textbook') }}"
                                            style="color: #ccc; font-size: 0.85rem; transition: all 0.3s;">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link rounded py-1 px-3" href="{{ route('koleksi.periodikal') }}"
                                            style="color: #ccc; font-size: 0.85rem; transition: all 0.3s;">
