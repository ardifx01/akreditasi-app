<div class="modal fade" id="pelatihanModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <!-- Form -->
        <form action="{{ route('pelatihan.store') }}" method="POST" enctype="multipart/form-data" id="formIjazah">
          @csrf
          <div class="modal-body">
            ...
            <!-- File Dokumen -->
            <div class="mb-3">
              <label for="file_dokumen" class="form-label">File Pelatihan</label>
          ...
          <div class="modal-footer">
            <button type="reset" class="btn btn-secondary" onclick="document.getElementById('pelatihanModal').querySelector('.btn-close').click()">Clear</button>
