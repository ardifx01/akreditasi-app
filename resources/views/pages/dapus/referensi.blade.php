...
@section('content')
    <div class="container">
        <h4>Statistik Koleksi Referensi @if ($prodi)
                - {{ $namaProdi }}
            @endif
        </h4>
            ...
            <div class="card-body">
                @if ($prodi && $data->isNotEmpty())
                    <div class="table-responsive">
                        ...
                        <button id="downloadExcelReferensi" class="btn btn-warning mt-3 mb-2">Save Tabel (Excel)</button>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            const downloadExcelButton = document.getElementById("downloadExcelReferensi");
            if (downloadExcelButton) {
                downloadExcelButton.addEventListener("click", function() {
                    const table = document.getElementById("myTableReferensi");
                    if (!table) {
                        console.error("Table 'myTableReferensi' not found.");
                        return;
                    }
                    let csv = [];
                    const delimiter = ';';
                    ...
                    const fileName = "referensi_data.csv";
