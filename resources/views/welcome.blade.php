...
<head>
    ...
    <title>SUPPORT ACCREDITATION</title>
</head>
<body>
    ...
    <div class="hero-section">
        <div class="hero-content">
            ...
            <p class="lead">
                Nikmati koleksi buku, jurnal, dan sumber daya digital yang luas untuk mendukung kebutuhan belajar dan penelitian Anda.
    ...
    <div class="container mt-4">
        ...
        <div class="row">
        <div class="col-md-3 col-sm-6 mb-4"> <div class="card shadow-sm h-100"> <div class="card-body d-flex flex-column justify-content-between">
                    <div>
                        <small class="text-muted">Total Jurnal</small>
                        <h4 class="card-title mt-2 mb-0">{{ $totalJurnal }}</h4>
                    </div>
                    <div class="text-end mt-3">
                        <i class="fas fa-book fa-2x text-primary"></i> </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-3 col-sm-6 mb-4">
            <div class="card shadow-sm h-100">
                <div class="card-body d-flex flex-column justify-content-between">
                    ...
                    <div class="text-end mt-3">
                        <i class="fas fa-book-open fa-2x text-success"></i> </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-3 col-sm-6 mb-4">
            <div class="card shadow-sm h-100">
                <div class="card-body d-flex flex-column justify-content-between">
                    ...
                    <div class="text-end mt-3">
                        <i class="fas fa-copy fa-2x text-info"></i> </div>
                </div>
            </div>
        </div>
    ...
    <div class="container mt-4"> 
        <div class="row">
            <div class="col-md-6 col-sm-6 mb-4"> <div class="card shadow-sm h-100"> <div class="card-body d-flex flex-column justify-content-between">
                        <div>
            ...
            <div class="col-md-6 col-sm-6 mb-4"> <div class="card shadow-sm h-100"> <div class="card-body d-flex flex-column justify-content-between">
                        <div>
                            ...
                            <h4 class="card-title mt-2 mb-0"><a href="http://statcounter.com/p13060651/summary/?guest=1" target="_blank">Klik Disini</a></h4>
                        </div>
                        <div class="text-end mt-3">
                ...
                <div class="card shadow-sm h-100">
                    ...
                    <div class="card-body">
                        <table id="bukuTerlarisTable" class="table table-striped table-bordered" style="width:100%">
                            ...
                            <tbody>
                                <tr><td>1</td><td>Membuat aplikasi tutorial inte...</td><td>MEMBUAT APLIKASI...</td><td>66</td></tr>
                                <tr><td>2</td><td>Buku ajar ilmu kesehatan anak...</td><td>GAVI. Allan</td><td>22</td></tr>
                                <tr><td>3</td><td>Teruslah bodoh jangan pintar</td><td>LIYE. Tere</td><td>21</td></tr>
                                <tr><td>4</td><td>Malam pertama</td><td>Tere Liye</td><td>18</td></tr>
                                <tr><td>5</td><td>Tentang kamu</td><td>Tere Liye</td><td>15</td></tr>
                                </tbody>
                        </table>
                    </div>
                </div>
